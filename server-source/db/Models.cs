...
public class Chars
{
    ...
    public List<ItemCostItem> ItemCostsList
    {
        get
        {
            ...
            {
                new ItemCostItem {Type = "900", Puchasable = 1, Expires = 0, Price = 90000},
                new ItemCostItem {Type = "902", Puchasable = 1, Expires = 0, Price = 90000},
                ...
                new ItemCostItem {Type = "850", Puchasable = 1, Expires = 1, Price = 900},
                new ItemCostItem {Type = "851", Puchasable = 1, Expires = 1, Price = 900},
                ...
                new ItemCostItem {Type = "856", Puchasable = 1, Expires = 0, Price = 90000},
                new ItemCostItem {Type = "883", Puchasable = 1, Expires = 0, Price = 90000}
            };
        }
    }
