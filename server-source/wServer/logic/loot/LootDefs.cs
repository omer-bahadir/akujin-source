        ...
        public static ILootDef[] DefaultEggLoot(EggRarity maxRarity)
        {
            switch(maxRarity)
            {
                case EggRarity.Common:
                    return new ILootDef[1] {new EggLoot(EggRarity.Common, 0.00000000000001) };
                case EggRarity.Uncommon:
                    return new ILootDef[2] { new EggLoot(EggRarity.Common, 0.00000000000001), new EggLoot(EggRarity.Uncommon, 0.00000000000001) };
                case EggRarity.Rare:
                    return new ILootDef[3] { new EggLoot(EggRarity.Common, 0.00000000000001), new EggLoot(EggRarity.Uncommon, 0.00000000000001), new EggLoot(EggRarity.Rare, 0.00000000000001) };
                case EggRarity.Legendary:
                    return new ILootDef[4] { new EggLoot(EggRarity.Common, 0.00000000000001), new EggLoot(EggRarity.Uncommon, 0.00000000000001), new EggLoot(EggRarity.Rare, 0.00000000000001), new EggLoot(EggRarity.Legendary, 0.00000000000001) };
                default:
